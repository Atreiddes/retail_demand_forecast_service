...
def gate(accuracy: dict | None, drift: list | None, breakdowns: dict | None = None) -> dict:
    ...
    (плановое смещение, промо, forecast value add)."""
    warnings = []
    if accuracy:
    ...
    return {"ok": not warnings, "warnings": warnings,
            "accuracy": accuracy, "drift": drift, "breakdowns": breakdowns}
